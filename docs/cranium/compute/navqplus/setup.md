...
??? tip "Looking for instructions on how to also install on a development computer?"
    ...
    [Click here to get instructions on how to setup and configure a development computer.](../../../../getting_started/install)
...
???+ tip "When prompted to choose a platform to build:"
    ...
    1. [***b3rb*** is an ackermann based mobile robotic platform.](../../../../reference_systems/b3rb/about)
